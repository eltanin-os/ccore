...
#line 135 "src/awk/awkgram.y"
                { setfname((yyvsp[0].cp)); }
#line 2403 "awk.tab.c"
    break;

  case 22: /* if: IF '(' pattern rparen  */
#line 139 "src/awk/awkgram.y"
                                        { (yyval.p) = notnull((yyvsp[-1].p)); }
#line 2409 "awk.tab.c"
    break;

  case 27: /* opt_nl: %empty  */
#line 151 "src/awk/awkgram.y"
                        { (yyval.i) = 0; }
#line 2415 "awk.tab.c"
    break;

  case 29: /* opt_pst: %empty  */
#line 156 "src/awk/awkgram.y"
                        { (yyval.i) = 0; }
#line 2421 "awk.tab.c"
    break;

  case 31: /* opt_simple_stmt: %empty  */
#line 162 "src/awk/awkgram.y"
                                        { (yyval.p) = 0; }
#line 2427 "awk.tab.c"
    break;
...
#line 168 "src/awk/awkgram.y"
                                        { (yyval.p) = (yyvsp[-1].p); }
#line 2439 "awk.tab.c"
    break;

  case 35: /* pa_pat: pattern  */
#line 172 "src/awk/awkgram.y"
...
#line 234 "src/awk/awkgram.y"
                                        { (yyval.p) = op3((yyvsp[-1].i), NIL, (yyvsp[-2].p), (Node*)makedfa((yyvsp[0].s), 0)); }
#line 2634 "awk.tab.c"
    break;

  case 71: /* pattern: pattern MATCHOP pattern  */
#line 236 "src/awk/awkgram.y"
                { if (constnode((yyvsp[0].p)))
			(yyval.p) = op3((yyvsp[-1].i), NIL, (yyvsp[-2].p), (Node*)makedfa(strnode((yyvsp[0].p)), 0));
		  else
			(yyval.p) = op3((yyvsp[-1].i), (Node *)1, (yyvsp[-2].p), (yyvsp[0].p)); }
...
#line 255 "src/awk/awkgram.y"
                                        { (yyval.p) = linkum((yyvsp[-2].p), (yyvsp[0].p)); }
#line 2689 "awk.tab.c"
    break;

  case 82: /* pplist: pplist comma ppattern  */
#line 260 "src/awk/awkgram.y"
                                        { (yyval.p) = linkum((yyvsp[-2].p), (yyvsp[0].p)); }
#line 2695 "awk.tab.c"
    break;

  case 83: /* prarg: %empty  */
#line 264 "src/awk/awkgram.y"
                                        { (yyval.p) = rectonode(); }
#line 2701 "awk.tab.c"
    break;

  case 85: /* prarg: '(' plist ')'  */
#line 266 "src/awk/awkgram.y"
                                        { (yyval.p) = (yyvsp[-1].p); }
#line 2707 "awk.tab.c"
    break;
...
#line 2713 "awk.tab.c"
  ...
  case 95: /* re: NOT re  */
#line 284 "src/awk/awkgram.y"
                        { (yyval.p) = op1(NOT, notnull((yyvsp[0].p))); }
#line 2719 "awk.tab.c"
    break;

  case 96: /* $@5: %empty  */
#line 288 "src/awk/awkgram.y"
              {startreg();}
#line 2725 "awk.tab.c"
    break;
...
#line 340 "src/awk/awkgram.y"
                                { (yyval.p) = 0; }
#line 2893 "awk.tab.c"
    break;

  case 130: /* stmtlist: stmtlist stmt  */
#line 345 "src/awk/awkgram.y"
...
#line 433 "src/awk/awkgram.y"
                                { arglist = (yyval.p) = 0; }
#line 3185 "awk.tab.c"
    break;

  case 182: /* varlist: VAR  */
#line 434 "src/awk/awkgram.y"
